...
[Additional attributes can be specified for the image](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Img#attributes) alongside the alternative text description
in the `{}`.
