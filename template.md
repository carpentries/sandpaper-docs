...
- How does the {varnish} differ from a Jekyll template?
- How does one update {varnish}?
...
<img src="fig/template-rendered-pyramid-1.png" title="plot of chunk pyramid" alt="plot of chunk pyramid" style="display: block; margin: auto;" />
